<?php
	...
	$PHPExcelWriter->save($g_date.'月結報表.xls');
	header("Content-type: application/force-download");
	header("Content-Disposition: attachment; filename=\"".$g_date."月結報表.xls\"");
	header("Content-Length: ".filesize($g_date.'月結報表.xls'));
	@readfile($g_date.'月結報表.xls');
?>