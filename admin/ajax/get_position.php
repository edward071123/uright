<?php
	...
	$sql = "SELECT m3.m_identify,m3.m_name,m3.m_live_zip,m3.m_gender,m1.intro_count,m5.get_m_t_income
		FROM member AS m3
		LEFT JOIN
	...
	foreach ($members as $member) {
		...
		$get_m_live_zip  = $member['m_live_zip'];
		...
		if($intro_count != 0){
			...
			$responce->rows[$ii]['cell']=array($ii+1,$idn,$get_m_live_zip,$get_m_name,$cla,
