				...
				$("#datepicker").datepicker({
					...
					onClose: function (dateText, inst) {
						...
						if (typeof this.blur === 'function') {
							this.blur();
							location.href = 'position.php?getdate='+this.value;
						}
					}
				});
				//================================================
				$("#list_level").jqGrid({
					url:'ajax/get_position.php',
					datatype: "json",
					mtype: 'GET',
					colNames:['序','登入編號','郵遞區號','會員姓名','職稱','招募人數','性別','累計儲值點數'],
					colModel:[
		...
		<div id="container">
			...
			<div id="content">
				...
				<div class="box">
					...
					<div class="right"></div>
					<div class="heading">
						<h1 style="background-image: url('image/user.png');">幹部列表</h1>
						<div class="buttons">
